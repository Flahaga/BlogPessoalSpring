package com.blogpessoal2.blogpessoal2.controller;
...
import com.blogpessoal2.blogpessoal2.repository.UsuarioRepository;
import com.blogpessoal2.blogpessoal2.service.UsuarioService;
...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario(0L, 
			"Paulo Antunes", "paulo_antunes@email.com.br", "1346527854", "https://i.imgur.com/JR7kUFU.jpg"));
	...
	public void naoDeveDuplicarUsuario() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, 
			"Maria da Silva", "maria_silva@email.com.br", "1346527854", "https://i.imgur.com/T12NIp9.jpg"));
